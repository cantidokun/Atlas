...
def test_authorized_replan_replaces_failed_future():
    ...
    orchestrator.install_authorized_replan(
        {"ready": False, "fresh": True},
        [ActionSpec("write", {"value": 2}, "write-replanned")],
    )
