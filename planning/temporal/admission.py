...
class AdmissionReasonCode(str, Enum):
    INVALID_CANONICAL_VALUE_DOMAIN = "INVALID_CANONICAL_VALUE_DOMAIN"
    UNKNOWN_SCHEMA_VERSION = "UNKNOWN_SCHEMA_VERSION"
    MALFORMED_IDENTITY = "MALFORMED_IDENTITY"
    MISSING_SOURCE_TIME = "MISSING_SOURCE_TIME"
    MALFORMED_TIME = "MALFORMED_TIME"
    CAPABILITY_UNIVERSE_INCOMPLETE = "CAPABILITY_UNIVERSE_INCOMPLETE"
    STATE_DIGEST_MISMATCH = "STATE_DIGEST_MISMATCH"
    ADMISSION_STATE_UNAVAILABLE = "ADMISSION_STATE_UNAVAILABLE"
