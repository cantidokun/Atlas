...
_TOOL_OPERATION_MAP: Mapping[str, Tuple[UnrealCapability, UnrealOperationKind]] = {
    ...
    "verify_actor_location": (UnrealCapability.MODIFY_ACTOR, UnrealOperationKind.VERIFY),
    "set_actor_rotation": (UnrealCapability.MODIFY_ACTOR, UnrealOperationKind.WRITE),
    "verify_actor_rotation": (UnrealCapability.MODIFY_ACTOR, UnrealOperationKind.VERIFY),
    "set_actor_scale": (UnrealCapability.MODIFY_ACTOR, UnrealOperationKind.WRITE),
    "verify_actor_scale": (UnrealCapability.MODIFY_ACTOR, UnrealOperationKind.VERIFY),
...
class UnrealExecutionBoundary:
    ...
    def tool_to_operation(self, tool: str, validated_arguments: Dict[str, Any]) -> Tuple[UnrealOperation, str]:
        ...
        # Construct arguments dictionary excluding authorization_id
        operation_arguments = {
        ...
        validated_op = self._capabilities.validate_operation(operation)
        return validated_op, authorization_id
