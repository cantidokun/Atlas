...
def curated_context_benchmark_cases() -> tuple[ContextBenchmarkCase, ...]:
    recovery_path = "planning/unreal_render_recovery_coordinator.py"
    cases = (
