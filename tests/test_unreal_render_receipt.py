...
def _evidence(**overrides):
    state = {
        ...
        "output_format": "png",
        "output_files": [
            "C:/renders/AtlasRender_0001.png",
        ],
    }
...
def test_render_receipt_rejects_unverified_evidence():
    evidence = UnrealEvidence(
        ...
        observed_state={
            "job_id": "job-123",
            "sequence_asset_path": "/Game/AtlasTest/Sequence",
        },
        verified=False,
        source="render-receipt-test",
    )
...
def test_render_receipt_detects_artifact_drift():
    ...
    changed = _evidence(
        output_files=[
            "C:/renders/AtlasRender_0001.png",
            "C:/renders/AtlasRender_0002.png",
        ]
    )
...
def test_render_receipt_detects_sequence_drift():
    ...
    assert not receipt.matches(
        _evidence(
            sequence_asset_path="/Game/AtlasTest/OtherSequence"
        )
    )
