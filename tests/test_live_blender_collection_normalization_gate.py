"""LIVE Blender gate for Wave 10 object-collection normalization."""
...
SCRIPT = Path(__file__).with_name("collection_normalization_live_script.py")
...
def test_wave10_live_blender_boundary():
    ...
    marker = next(
        (line for line in proc.stdout.splitlines() if line.startswith("ATLAS_WAVE10_COLLECTION_LIVE_RESULT=")),
        None,
    )
    ...
    assert "ATLAS_WAVE10_COLLECTION_LIVE_PASS" in proc.stdout
